...
class AdHocSystemClassification(AliasedNameEnum):
    ...
    StartFromDeviceEnabled: AliasedName = AliasedName(
        ...
        ("R7525_A30x3",
         ...
         "DSS8440_A100-PCIE-80GBx10",
         "DSS8440_A30x8",
         "R750xa_A100-PCIE-40GBx4",
         "R750xa_A100-PCIE-80GB-MIG_28x1g.10gb",
         "R750xa_A100-PCIE-80GBx4",
         "R7525_A100-PCIE-40GBx3",
         "XE8545_A100-SXM-80GBx4",
         "XE8545_A100-SXM-80GB-MIG_28x1g.10gb"))
