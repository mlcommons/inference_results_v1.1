...
ALTRA_G242_P31_01 = Machine(
    ...
    host_storage_type="NVMe SSD",
    accelerator_model_name="NVIDIA A100-PCIe-40GB",
    accelerator_short_name="A100-PCIe-aarch64",
    mig_short_name="",
    accelerator_memory_capacity="40 GB",
    accelerator_memory_configuration="HBM2",
    hw_notes="",
...
submission_systems = [
    ...
    # System(IPP1_1470_MIG_1, Division.CLOSED, SystemType.DATACENTER, 8, 4, False, False),  # A30-MIG_32x1g.6gb_TRT
    ...
    # System(SJC1_LUNA_02_MIG_1, Division.CLOSED, SystemType.DATACENTER, 8, 7, False, False),  # A100-SXM-80GB-MIG-56x1g.10gb
    ...
    # System(COMPUTELAB_RO_PROD_01, Division.CLOSED, SystemType.DATACENTER, 4, 0, True, False, True),  # A100-SXM-80GBx4-Triton-MaxQ
    System(ALTRA_G242_P31_01, Division.CLOSED, SystemType.DATACENTER, 2, 0, False, False, False),  # A100-PCIe-40GB-aarch64x2
    System(ALTRA_G242_P31_01, Division.CLOSED, SystemType.DATACENTER, 4, 0, False, False, False),  # A100-PCIe-40GB-aarch64x4
    System(ALTRA_G242_P31_01, Division.CLOSED, SystemType.DATACENTER, 4, 0, False, False, True),  # A100-PCIe-40GB-aarch64x4-MaxQ
    ...
    System(ALTRA_G242_P31_01, Division.CLOSED, SystemType.EDGE, 1, 0, False, False, False),  # A100-PCIe-40GB-aarch64x1
]
