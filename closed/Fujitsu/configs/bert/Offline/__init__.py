...
class A30x2(A30x1):
    ...
    offline_expected_qps = 3941.99999999999998

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class A30x4(A30x1):
    system = System("A30", Architecture.Ampere, 4)
    offline_expected_qps = 6660.99999999999998
    gpu_batch_size = 256
...
class A30x2_HighAccuracy(A30x2):
    precision = "fp16"
    offline_expected_qps = 2029.999999999995

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A30x4_HighAccuracy(A30x4):
    precision = "fp16"
    offline_expected_qps = 4059.999999999995
    gpu_batch_size = 128
