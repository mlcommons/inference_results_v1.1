...
class KnownSystems(object):
    ...
    A100_PCIe_80GB = SystemClass("A100-PCIE-80GB", ["A100-PCIE-80GB"], ["20B5"], Architecture.Ampere, [4])  # Placeholder
    #A100_PCIe_80GB_aarch64 = SystemClass("A100-PCIe-80GB", ["A100-PCIE-80GB"], ["20B5"], Architecture.Ampere, [2, 4], cpu_arch=CPUArch.aarch64)
