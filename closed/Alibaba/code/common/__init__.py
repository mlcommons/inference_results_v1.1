...
# TODO: BENCHMARKS and SCENARIOS really should extend enum.Enum, that way we won't need this hacky 'Name' type. I don't
# feel comfortable just appending `(Enum)` to it, as I feel `aliases` and `ALL` should *not* be in an Enum. This needs
# to be cleaned up.
class BENCHMARKS:
    ...
    class Name(str):
        """
        Custom class to wrap a string, to denote a Benchmark name. Helps to assert type checks.
        """
        pass
    ...
    SSDMobileNet = Name("ssd-mobilenet")
...
class SCENARIOS:
    ...
    class Name(str):
        """
        Custom class to wrap a string, to denote a Scenario name. Helps to assert type checks.
        """
        pass
    ...
    Server = Name("Server")
    SingleStream = Name("SingleStream")
    ALL = [
        SingleStream,
        Offline,
        Server
