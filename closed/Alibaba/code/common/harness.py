...
plugin_map = {
    ...
    BENCHMARKS.SSDMobileNet: ["build/plugins/NMSOptPlugin/libnmsoptplugin.so", "code/ssd-mobilenet/tensorrt/libautosinianconvfusionplugin.so"],
    BENCHMARKS.SSDResNet34: ["build/plugins/NMSOptPlugin/libnmsoptplugin.so"],
    BENCHMARKS.UNET: ["build/plugins/pixelShuffle3DPlugin/libpixelshuffle3dplugin.so",
