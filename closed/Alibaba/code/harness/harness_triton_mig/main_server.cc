...
boost::unordered::unordered_map<std::string, std::vector<std::string>> get_gpu_mig_map()
{
    boost::unordered::unordered_map<std::string, std::vector<std::string>> gpu_to_migs{};
