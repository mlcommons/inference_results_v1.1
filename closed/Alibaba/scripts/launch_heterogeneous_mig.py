...
from code.common import BENCHMARKS, SCENARIOS, get_system, logging
...
BENCHMARK_SCENARIO_ALL: Final[BenchmarkScenarioMapT] = {
    BENCHMARKS.UNET: {SCENARIOS.Offline, SCENARIOS.SingleStream},
    BENCHMARKS.BERT: {SCENARIOS.Offline, SCENARIOS.SingleStream, SCENARIOS.Server},
    BENCHMARKS.DLRM: {SCENARIOS.Offline, SCENARIOS.Server},
    BENCHMARKS.RNNT: {SCENARIOS.Offline, SCENARIOS.SingleStream, SCENARIOS.Server},
    BENCHMARKS.ResNet50: {SCENARIOS.Offline, SCENARIOS.SingleStream, SCENARIOS.Server},
    BENCHMARKS.SSDMobileNet: {SCENARIOS.Offline, SCENARIOS.SingleStream},
    BENCHMARKS.SSDResNet34: {SCENARIOS.Offline, SCENARIOS.SingleStream, SCENARIOS.Server},
}
...
BENCHMARK_DEFAULT_CONFIG: Final[Dict[str, str]] = {
    BENCHMARKS.UNET: 'hetero_high_accuracy',
    BENCHMARKS.BERT: 'hetero',
    BENCHMARKS.DLRM: 'hetero_high_accuracy',
    BENCHMARKS.RNNT: 'hetero',
    BENCHMARKS.ResNet50: 'hetero',
    BENCHMARKS.SSDMobileNet: 'hetero',
    BENCHMARKS.SSDResNet34: 'hetero',
}
...
def run_main_benchmark(main_benchmark: str,
    ...
    cmd = main_cmd_template.format(
        ...
        main_benchmark,
        main_scenario,
        BENCHMARK_DEFAULT_CONFIG[BENCHMARKS.alias(main_benchmark)],
        main_benchmark_duration
    )
...
def main():
    ...
    assert SCENARIOS.alias(args.main_scenario) in SUPPORT_MATRIX[GPU_INSTANCE][BENCHMARKS.alias(args.main_benchmark)],\
    ...
    main_cmd_template, background_cmd_template =\
        get_cmd_templates(args.main_benchmark_runargs, args.verbose, args.verbose_all, str(background_logdir_path))
