...
from code.common.config_parser import get_system_benchmark_config, update_nested
...
class ConfigGrid:
    ...
    def cross_to_standalone_config(self, cross_term):
        ...
        # Need to do a deep update (to handle things like config_ver )
        update_nested(dupe, cross_term)
