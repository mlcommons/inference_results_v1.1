...
python3 run.py --workload-name resnet50 \
    ...
    --workload-config resnet50/pytorch-cpu/scripts/ICX/resnet50-config_ServerAcc_ICX40C_2S.yml \
    --num-instance 20 \
    --cpus-per-instance 4 \
    --warmup 0 \
    --scenario Server \
    --mode Accuracy 
python3 resnet50/pytorch-cpu/accuracy-imagenet.py --mlperf-accuracy-file output_logs/mlperf_log_accuracy.json --imagenet-val-file /root/mlperf_data/resnet50/dataset/ILSVRC2012_img_val/val_map.txt --dtype int32
