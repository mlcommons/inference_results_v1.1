  ...
  bash ${REPODIR}/closed/Intel/code/prepare_loadgen.sh ${WORKDIR}
  # supply commit id for validation stability
  bash ${REPODIR}/closed/Intel/code/prepare_pytorch.sh ${WORKDIR}
  ...
  cp $WORKDIR/mlperf_inference/mlperf.conf  ${REPODIR}/closed/Intel/code/rnnt/pytorch-cpu/.
  set +x
