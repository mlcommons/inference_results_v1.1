...
class DLRM_Net(nn.Module):
    ...
    def fuseinteractemb(self, lS_o, lS_i, x):
        if self.use_ipex and (not self.bf16):
            z = ipex.fuseinteractemb(lS_o, lS_i, self.emb_l_w, x)
        else:
    ...
    def sequential_forward(self, dense_x, lS_o, lS_i):
        ...
        z = self.fuseinteractemb(lS_o, lS_i, x)
