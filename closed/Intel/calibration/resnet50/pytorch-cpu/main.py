##########################################################################################################################
#####    Original source of this script: https://github.com/XiaobingSuper/examples/tree/int8/imagenet
##########################################################################################################################
import argparse
import os
import random
...
parser.add_argument('modeldir', metavar='DIR',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print("adding MlPerf weights") 
    model.load_state_dict(torch.load(args.modeldir))
