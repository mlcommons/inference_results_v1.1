...
system_name_map = [
    # NF5688M6 and NF5488A5 are using the same GPU
    # In current code, can't distinguish those two systems
    # when test with NF5688M6, uncomment the "NF5688M6" lines, 
    # and comment the the "NF5488A5" lines. 
    # Similar operation when test with "NF5488A5"
    #("A100-SXM-80GBx8", "NF5688M6"),
    #("A100-SXM-80GBx1", "NF5688M6"),
    ("A100-SXM-80GBx8", "NF5488A5"),
    ("A100-SXM-80GBx1", "NF5488A5"),
