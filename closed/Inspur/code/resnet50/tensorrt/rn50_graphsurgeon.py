...
SERIAL3CONV2D_PLUGIN_LIBRARY="build/plugins/Serial3Conv2dPlugin/libserial3conv2dplugin.so"
if not os.path.isfile(SERIAL3CONV2D_PLUGIN_LIBRARY):
    raise IOError("{}\n{}\n".format(
        "Failed to load library ({}).".format(SERIAL3CONV2D_PLUGIN_LIBRARY),
        "Please build the NMS Opt plugin."
    ))
ctypes.CDLL(SERIAL3CONV2D_PLUGIN_LIBRARY)
