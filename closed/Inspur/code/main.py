...
__doc__ = """Inspur's MLPerf Inference Benchmark submission code. Inspur's implementation runs in 2 phases.
...
More about the MLPerf Inference Benchmark and Inspur's submission implementation can be found in the README.md for this
project.
"""
