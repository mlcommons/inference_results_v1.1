...
class A100_SXM_80GBx8(BenchmarkConfiguration):
    ...
    use_small_tile_gemm_plugin = True
    complete_threads = 1
    gemm_plugin_fairshare_cache_size = 12
    gpu_batch_size = 393216
    offline_expected_qps = 2620000
    max_pairs_per_staging_thread = 262100
    start_from_device = True
    use_jemalloc = True
    scenario = Scenario.Offline
...
#NF5688M6: When test with NF5688M6, please uncomment the following config
# and comment the config for NF5488A5 above
#@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
#class A100_SXM_80GBx8(BenchmarkConfiguration):
#    system = System("A100-SXM-80GB", Architecture.Ampere, 8)
#    check_contiguity = True
