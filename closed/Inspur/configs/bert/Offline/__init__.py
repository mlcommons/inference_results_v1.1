...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIex2_HighAccuracy(A100_PCIex2):
    precision = "fp16"
    offline_expected_qps = 3500

@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_PCIex2_Triton(A100_PCIex2):
    use_triton = True
    gpu_batch_size = 1024
    gpu_copy_streams = 3
    gpu_inference_streams = 1
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIex2_HighAccuracy_Triton(A100_PCIex2_HighAccuracy):
    use_triton = True
    offline_expected_qps = 3500

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxQ)
class A100_PCIex2_MaxQ(A100_PCIex2):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxQ)
class A100_PCIex2_HighAccuracy_MaxQ(A100_PCIex2_MaxQ):
    precision = "fp16"
    offline_expected_qps = 2790

@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxQ)
class A100_PCIex2_Triton_MaxQ(A100_PCIex2_MaxQ):
    use_triton = True
    offline_expected_qps = 6800


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxQ)
class A100_PCIex2_HighAccuracy_Triton_MaxQ(A100_PCIex2_HighAccuracy_MaxQ):
    use_triton = True
    offline_expected_qps = 2792