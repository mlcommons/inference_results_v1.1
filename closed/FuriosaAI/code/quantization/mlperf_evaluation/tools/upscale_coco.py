...
def parse_args():
    ...
    parser.add_argument(
        "--inputs", "-i", type=str, default="/coco", help="input directory for coco dataset"
    )
    parser.add_argument(
        "--outputs",
        "-o",
    ...
    parser.add_argument("--images", "-im", type=str, default="val2017", help="image directory")
    parser.add_argument(
        "--annotations",
        "-a",
        type=str,
    ...
    parser.add_argument("--format", "-f", type=str, default="jpg", help="image format")
