...
def tile_anchors(
    grid_height, grid_width, scales, aspect_ratios, base_anchor_size, anchor_stride, anchor_offset
):
...
class MultipleGridAnchorGenerator(object):
    ...
    def __init__(
        ...
        for arg, arg_name in zip(
            [self._anchor_strides, self._anchor_offsets], ["anchor_strides", "anchor_offsets"]
        ):
