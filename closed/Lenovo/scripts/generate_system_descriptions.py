...
# TODO: Add A100-PCIe-80GBx8 machine
# TODO: Add ARM-A100 machine
...
class System():
    ...
    def _get_framework(self, machine, division, gpu_count, mig_count, is_triton, is_xavier, is_maxq, additional_config):
        ...
        if division == Division.CLOSED:
            frameworks.append(trt_version if not is_xavier else xavier_trt_version)
...
submission_systems = [
    ...
    System(COMPUTELAB_310, Division.CLOSED, SystemType.EDGE, 1, 0, True, True),  # AGX Xavier Triton
    ...
    System(COMPUTELAB_501, Division.CLOSED, SystemType.EDGE, 1, 0, True, True),  # Xavier NX Triton
