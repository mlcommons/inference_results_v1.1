...
class Triton_CPU_2S_8360Yx1_Triton(BenchmarkConfiguration):
    ...
    num_instances = 20
    ov_parameters = {'CPU_THREADS_NUM': '72', 'CPU_THROUGHPUT_STREAMS': '18', 'ENABLE_BATCH_PADDING': 'NO', 'SKIP_OV_DYNAMIC_BATCHSIZE': 'YES'}
    server_target_qps = 2875
    use_triton = True
