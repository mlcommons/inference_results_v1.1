...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class Triton_CPU_2S_8360Yx1_Triton(BenchmarkConfiguration):
    ...
    num_instances = 72
    ov_parameters = {'CPU_THREADS_NUM': '72', 'CPU_THROUGHPUT_STREAMS': '36', 'ENABLE_BATCH_PADDING': 'YES', 'SKIP_OV_DYNAMIC_BATCHSIZE': 'YES'}
    use_triton = True
