...
class A100_PCIe_80GBx1_HighAccuracy(BenchmarkConfiguration):
    system = System("A100-PCIe-80GB", Architecture.Ampere, 1)
    check_contiguity = True
    coalesced_tensor = True
    enable_interleaved_top_mlp = False
...
class A100_PCIe_80GBx1_HighAccuracy_Triton(BenchmarkConfiguration):
    system = System("A100-PCIe-80GB", Architecture.Ampere, 1)
    check_contiguity = True
    coalesced_tensor = True
    enable_interleaved_top_mlp = False
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIe_80GBx8_HighAccuracy(BenchmarkConfiguration):
    system = System("A100-PCIe-80GB", Architecture.Ampere, 8)
    check_contiguity = True
    coalesced_tensor = True
    enable_interleaved_top_mlp = False
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIe_80GBx8_HighAccuracy_Triton(BenchmarkConfiguration):
    system = System("A100-PCIe-80GB", Architecture.Ampere, 8)
    check_contiguity = True
    coalesced_tensor = True
    enable_interleaved_top_mlp = False
